(function ($) {
	...
	***************************************************/
	var createMap = function(key, name, title){
	   ...
	   $('.view-reportes.view-display-id-page_6 #'+key+'-wrapper input').css('display','none');
	   $('.view-reportes.view-display-id-page_6 #'+key+'-wrapper').css({'width':'100%'});
	   ...
	   ***************************************************/
		...
		"select": new OpenLayers.Style({
		 ...
		 $('.view-reportes.view-display-id-page_6 #'+key+'-wrapper').append('<legend><span class="fieldset-legend">'+title+'</span></legend>\
	    ...
	    $(".page-reportes-muestreo select").multiselect({ enableFiltering: true });
	  	...
	  	$.each(Drupal.settings.geo_filters, function( key, name ) {
                   ...
                   if($('#'+key).html()!=null){
                      name= name.split('|');                   
	                     ...
	                     $(".view-reportes.view-display-id-page_6 #edit-geo-field-ubicacion-wrapper").append('<div id="nomenclatura-wrapper" style="position:relative; top:-10px"><ul class="nomeclatura"><li class="title">Simbología:</li>'+
