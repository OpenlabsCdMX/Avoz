...
/*New styles*/
	    ...
	    $(".page-reportes-sitios-localidades-centro select").multiselect({ enableFiltering: true });
	     ...
	     ***************************************************/  
		  $('#ctrl-delete-'+name).click(function() {
           ...
           $.each(cartaro_reportes_results.response.docs, function(i, item) {	
			...
			//mapsLayers[11].addFeatures(features_lines);
	  	...
	  	$.each(Drupal.settings.geo_filters, function( key, name ) {
                   if($('#'+key).html()!=null){
                      name= name.split('|');                   
	                     ...
	                     $("#edit-geo-field-ubicacion-wrapper").append('<div id="nomenclatura-wrapper" style="position:relative; top:-10px"><ul class="nomeclatura"><li class="title">Simbolog&iacute;a:</li>'+
